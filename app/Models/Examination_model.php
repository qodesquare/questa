<?php
	...
	class Examination_model extends Base_model {
        ...
        protected $table_4 = 'examination_attachments_tb';
        protected $table_5 = 'generated_exams_tb';
        ...
        public function get_generated_exam($where = false) {
        ...
        public function add_generated_exam($data) {
        ...
        public function update_generated_exam($data, $where) {

            $query = $this->db->table($this->table_5)->update($data, $where);
            return $query;

        }

        public function delete_generated_exam($where) {
