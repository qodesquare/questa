...
<head>
    <title>Questa Online Exams | View Examination - Multichoice</title>
    ...
    <style type="text/css">
        ...
        .question_card:hover .delete_question_btn, .question_card:hover .ordering_panel {
            opacity: 1 !important;
        }
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><?= $examination['exam_title']; ?> <span class = "small">[Multichoice]</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="questions" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="alert border fade show d-flex justify-content-between align-items-center" role="alert">
                                ...
                                <button id = "add_question_btn" data-toggle = "tooltip" title = "Add question to the list" onclick="add_question();" class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i>Add</button>
                            </div>
                                    ...
                                    <div class="card-body shadow-0">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3 d-flex justify-content-between align-items-center">
                                                ...
                                                <div class = "d-flex justify-content-center align-items-center">
                                                    <button onclick = "add_question(1, '#<?= $item['question_id']; ?>');" data-toggle = "tooltip" title = "Click to insert question after this one." class = "btn btn-info btn-sm mr-2 delete_question_btn" style = "opacity: 0;"><i class = "fas fa-plus-circle"></i></button>
                                            ...
                                            <div class="col-md-12 col-lg-9 col-sm-12 d-flex align-items-start mb-3">
                                                <div class="p-2 border h-100 w-100 rounded question_title ck_editable" id = "ck_editable<?= $item['question_id']; ?>" contenteditable = "true"><?= $item['question_title']; ?></div>
                                            </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 mb-3">
                                                <div class="border p-2 rounded question_options d-flex">
                                                    <div class="mr-2 font-weight-bold d-inline-block">A. </div>
                                                    <div id = "ck_editable_option_a<?= $item['question_id']; ?>" contenteditable = "true" class = "ques_option d-inline-block w-100"><?= $item['option_a']; ?></div>
                                                </div>
                                            </div>

                                            <div class="col-sm-12 col-md-6 mb-3">
                                                <div class="border p-2 rounded question_options d-flex">
                                                    <div class="mr-2 font-weight-bold d-inline-block">B. </div>
                                                    <div id = "ck_editable_option_b<?= $item['question_id']; ?>" contenteditable = "true" class = "ques_option d-inline-block w-100"><?= $item['option_b']; ?></div>
                                                </div>
                                            </div>

                                            <div class="col-sm-12 col-md-6">
                                                <div class="border p-2 rounded question_options d-flex">
                                                    <div class="mr-2 font-weight-bold d-inline-block">C. </div>
                                                    <div id = "ck_editable_option_c<?= $item['question_id']; ?>" contenteditable = "true" class = "ques_option d-inline-block w-100"><?= $item['option_c']; ?></div>
                                                </div>
                                            </div>

                                            <div class="col-sm-12 col-md-6">
                                                <div class="border p-2 rounded question_options d-flex">
                                                    <div class="mr-2 font-weight-bold d-inline-block">D. </div>
                                                    <div id = "ck_editable_option_d<?= $item['question_id']; ?>" contenteditable = "true" class = "ques_option d-inline-block w-100"><?= $item['option_d']; ?></div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <select id = "answer_for_question_<?= $item['question_id']; ?>" class="form-control form-control-sm" onchange = "make_display('btn_submit_answer_<?= $item['question_id']; ?>');">
                                                                    <option value = "">Please select an option</option>
                                                                    <option value="option_a" <?= ($item['answer'] == 'option_a') ? 'selected': ''; ?> >A. <?= $item['option_a']; ?></option>
                                                                    <option value="option_b" <?= ($item['answer'] == 'option_b') ? 'selected': ''; ?> >B. <?= $item['option_b']; ?></option>
                                                                    <option value="option_c" <?= ($item['answer'] == 'option_c') ? 'selected': ''; ?> >C. <?= $item['option_c']; ?></option>
                                                                    <option value="option_d" <?= ($item['answer'] == 'option_d') ? 'selected': ''; ?> >D. <?= $item['option_d']; ?></option>
                                                                </select>
                                                                <button id = "btn_submit_answer_<?= $item['question_id']; ?>" onclick="set_answer(this, '<?= $item['question_id']; ?>')" data-toggle = "tooltip" title = "Set answer for this question." class="btn btn-info btn-sm d-none"><i class="fas fa-upload"></i></button>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group input-group-sm">
                                                            ...
                                                            <input onkeyup = "make_display('btn_submit_points_<?= $item['question_id']; ?>');" onchange = "make_display('btn_submit_points_<?= $item['question_id']; ?>');" id = "points_for_question_<?= $item['question_id']; ?>" min = "0" max = "127" type="number" class="form-control" value = "<?= ($item['points'] == 0) ? 1: $item['points']; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php foreach($exam_candidates as $candidate):
                                                    ...
                                                    if (isset($candidate['access_token']))
...
<!--<div class = "hints_panel" style = "position: fixed; bottom: 10px; left: 10px; background: white; width: 100px; height: 100px; border-radius: 999999999999999px">-->
...
<!-- [ Main Content ] end -->
        ...
        function delete_file(file_id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.notify(
                        "Operation succes! File delete successful!",
                        'success'
                    );
    ...
    <script>
        $("body").append(`
            <div id = "fixed_btn" class="text-center fixed-button active d-flex flex-column" style = "display: none; background: transparent !important; box-shadow: 0 0px 0px rgb(0 0 0 / 35%)">
                <button onclick = "scroll_to_top();" class = "btn btn-dark px-3 btn-sm d-block mb-1" data-toggle = "tooltip" title = "Scroll up">
                    <i class = "fas fa-angle-up"></i>
                </button>
                <button id = "add_question_btn_2" data-toggle = "tooltip" title = "Add Question" onclick = "$('#add_question_btn').click();"  class = "btn btn-primary px-3 btn-sm">
                    <i class = "fas fa-plus"></i>
                </button>
                <button onclick = "scroll_to_down();" class = "btn btn-dark px-3 btn-sm d-block mt-1" data-toggle = "tooltip" title = "Scroll down">
    ...
    <script type="text/javascript">
        ...
        function toggle_btn() {
            ...
            $("#add_question_btn_2").toggleClass('d-none');

        }

        function fetch_candidates(obj) {

            $("#notif").removeClass('d-none');

            $.ajax({

                url: '<?= base_url('classes/fetch_candidates'); ?>',
                type: 'POST',
                data: {
                    class_id: $(obj).val(),
        ...
        function set_answer(obj, question_id) {

            $(obj).html('<i class = "fas fa-spinner fa-spin"></i>');
            option = $("#answer_for_question_" + question_id).val();

            $.ajax({

                url: "<?= base_url('questions/set_answer'); ?>",
                type: 'POST',
                data: {
                ...
                success: function(data) {
                    ...
                    $.notify(
                        "Answer: " + option + " set for question ID: " + question_id,
                        'success'
                    );
                    ...
                    $(obj).html('<i class = "fas fa-upload"></i>');
                },
                error: function(error) {
                    console.log(error);
                    alert('Something went wrong! Try again.');
        ...
        function submit_questions(obj) {
            ...
            for (i = 0; i < questions.length; i++) {
                ...
                title = $($(questions[i]).find("div.question_title")).html();
                option = $(questions[i]).find("div.ques_option");
                image = $($(questions[i]).find("img.ques_image")).attr('src');
                question_id = $(questions[i]).attr('id');

                question_answer = $("#answer_for_question_" + question_id);
                ...
                var question = {
                    question_id: question_id,
                    title: title,
                    option_a: $(option[0]).html(),
                    option_b: $(option[1]).html(),
                    option_c: $(option[2]).html(),
                    option_d: $(option[3]).html(),
                    image: image,
        ...
        function add_question(target_type = 0, element_to_target = "#question_container") {
            ...
            option_b_id = code_generator();
            option_c_id = code_generator();
            option_d_id = code_generator();
            
            question_object = `
                <div class="card shadow-0 border question_card mb-4" id = "${question_id}" style="box-shadow: 0px 0px 0px 0px transparent;">
                    <div class = "ordering_panel" style = "opacity: 0">
                        <div class = "d-flex justify-content-center">
                            <button onclick = "reorder(this, 'up')" title = "Move Up" class = "rounded-0 btn btn-sm border text-primary">&#8593;</button>
                            <button onclick = "reorder(this, 'down')" title = "Move Down" class = "rounded-0 btn btn-sm border text-primary">&#8595;</button>
                    ...
                    <div class="card-body shadow-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-3 col-sm-12 mb-3">
                                <div class="border rounded">
                                    <div style = "height: 100px; overflow: hidden; position: relative;">
                                        <img onerror = "place_image(this);" id = "question_image_${question_id}" data-toggle = "tooltip" title = "Click image to enlarge" style = "cursor: pointer" onclick = "view_image(this);" src="<?= UPLOAD_PATH . 'questions/image_question.png'; ?>" class = 'img-fluid rounded-top border-bottom ques_image w-100'>
                                    </div>
                            ...
                            <div class="col-md-12 col-lg-9 col-sm-12 d-flex align-items-start mb-3 pl-0">
                                <div  class="p-2 border h-100 w-100 rounded question_title" contenteditable = "true" id = "ck_editable${question_id}"></div>
                            </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 mb-3">
                                <div class="border p-2 rounded question_options d-flex">
                                    <div class="mr-2 font-weight-bold d-inline-block">A. </div>
                                    <div contenteditable = "true" class = "ques_option d-inline-block w-100" id = "ck_editable_option_a${option_a_id}"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6 mb-3">
                                <div class="border p-2 rounded question_options d-flex">
                                    <div class="mr-2 font-weight-bold d-inline-block">B. </div>
                                    <div contenteditable = "true" class = "ques_option d-inline-block w-100" id = "ck_editable_option_b${option_b_id}""></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="border p-2 rounded question_options d-flex">
                                    <div class="mr-2 font-weight-bold d-inline-block">C. </div>
                                    <div contenteditable = "true" class = "ques_option d-inline-block w-100" id = "ck_editable_option_c${option_c_id}""></div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="border p-2 rounded question_options d-flex">
                                    <div class="mr-2 font-weight-bold d-inline-block">D. </div>
                                    <div contenteditable = "true" class = "ques_option d-inline-block w-100" id = "ck_editable_option_d${option_d_id}"></div>
                                </div>
                            </div>
            ...
            if (target_type == 0) { // If a parent target
                ...
                $('html, body').animate({
                    scrollTop: Number($(element_to_target).offset().top) + 250
                }, 'fast', 'swing');
            }

            CKEDITOR.disableAutoInline = true;
            CKEDITOR.inline("ck_editable" + question_id);

            CKEDITOR.inline("ck_editable_option_a" + option_a_id);
            CKEDITOR.inline("ck_editable_option_b" + option_b_id);
            CKEDITOR.inline("ck_editable_option_c" + option_c_id);
            CKEDITOR.inline("ck_editable_option_d" + option_d_id);
    ...
    <script type="text/javascript">
        ...
        function reorder(target_button, direction) {
            ...
            // console.log($("#" + element_before_parent).attr('id'));
            // console.log($("#" + element_after_parent).attr('id'));
