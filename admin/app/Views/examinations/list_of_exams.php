...
<head>
    <title>Questa Online Exams | Examinations</title>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="d-block m-t-5">Showing list of all examinations in this app.</span>
                        </div>
                        <div>
                            <a href="<?= base_url('examinations/add_examination'); ?>" class="btn btn-primary btn-sm">Create Exam</a>
                        </div>  
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('examinations/edit_examination/' . $item['exam_id']); ?>" class="btn btn-outline-warning btn-sm"><i class="fas fa-edit"></i></a>
                                            <?php if (is_owner_account()): ?>
                                            <button onclick="delete_item('<?= $item['exam_id']; ?>');" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
