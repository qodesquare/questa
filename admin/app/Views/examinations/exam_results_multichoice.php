...
<head>
    <title>Questa Online Quiz App | Exam Results - Multichoice</title>
                            ...
                            <table class="table" id = "items_table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php $time_spent = $hour . "h : " . $minute . "m : " . $seconds . "s"; ?>
                                            <div style = "cursor: default" data-toggle = "tooltip" title="<?= $item['first_name'] . " " . $item['last_name']; ?> spent <?= $percentage; ?>% of the total time for this examination.">
                                                ...
                                                <div class="progress" style = "height: 2px" data-toggle = "tooltip" title="<?= $item['first_name'] . " " . $item['last_name']; ?> spent <?= $percentage; ?>% of the total time for this examination.">
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a data-toggle = "tooltip" title = "Show result for this candidate" target="_blank" href="<?= base_url('examinations/view_result/' . $item['entry_id'] . "/" . $examination['exam_id']); ?>" class = "btn btn-outline-primary btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>

                                            <button data-toggle = "tooltip" title = "Delete result for this candidate" onclick="delete_attempt('<?= $item['entry_id']; ?>', '<?= $examination['exam_id']; ?>');" class="btn btn-sm btn-outline-danger">
