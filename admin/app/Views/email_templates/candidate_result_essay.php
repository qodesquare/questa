...
<body>
	...
	<div class="container">
		...
		<div class="mid_content">
			...
			<div><small><i>Essay Type</i></small></div>
		...
		<div class="items_to_start" style = "margin-bottom: 50px">
			...
			<table border = 1 style = "border-collapse: collapse" width = "100%" cellpadding = "10">
			    ...
			    <tbody>
			    	...
			    	<?php if ($result_list): ?>
			    	<?php foreach($result_list as $k => $r_l): ?>

			    	<tr>
			    		<td><?= ($k + 1); ?></td>
				        <td><?= $r_l->question; ?></td>
				        <td><?= $r_l->candidate_response; ?></td>
				        <td><?= $r_l->score . " / " . $r_l->obtainable; ?></td>
					</tr>
					...
					<tr>
						<td colspan="4"><b>OUTCOME: <?= $correct_points; ?> / <?= $total_points; ?></b></td>
					</tr>
