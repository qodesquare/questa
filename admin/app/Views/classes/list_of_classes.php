...
<head>
    <title>Questa Online Exams | Classes</title>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="d-block m-t-5">Showing list of all classes in this app.</span>
                        </div>
                        <?php if (is_owner_account()): ?>
                        <div>
                            <a href="" data-toggle = "modal" data-target = "#add_modal" class="btn btn-primary btn-sm">Add Class</a>
                        </div>
                        <?php endif; ?>  
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover" id = "items_table">
                                ...
                                <tbody>
                                    <?php if ($classes): rsort($classes); ?>
                                    <?php foreach($classes as $k => $item): ?>
                                    <tr>
                                        <td><?= $k + 1; ?></td>
                                        ...
                                        <td><?= date("jS M, Y"); ?></td>
                                        <td>
                                            <button onclick="fetch_item(this, '<?= $item['class_id']; ?>');" class="btn btn-outline-warning btn-sm"><i class="fas fa-edit"></i></button>
                                            <?php if (is_owner_account()): ?>
                                            <button onclick="delete_item('<?= $item['class_id']; ?>');" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
...
<!-- [ Main Content ] end -->
    ...
    <div class="modal fade" id="add_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <form action="<?= base_url('classes/add_class'); ?>" method = "POST" enctype="multipart/form-data">

            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title font-weight-bold">New Class</h4>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name = "add_class_btn" class="btn btn-primary btn-sm">Submit</button>
              </div>
            </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <form action="<?= base_url('classes/edit_class'); ?>" method = "POST" enctype="multipart/form-data">

            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title font-weight-bold">Edit Class</h4>
                <button type="button" class="close" style="background: transparent !important;" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" name = "edit_class_btn" class="btn btn-primary">Update</button>
              </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function fetch_item(obj, id) {
            ...
            $.ajax({
                ...
                url: '<?= base_url('classes/fetch_class'); ?>',
                type: 'POST',
                data: {
                    class_id: id
                },
        ...
        function delete_item(id) {
            ...
            var prompt = confirm("Are you sure to delete this class?");

            if (prompt == 1) {
                window.location.href = "<?= base_url('classes/delete_class/'); ?>/" + id;
            }
        }
